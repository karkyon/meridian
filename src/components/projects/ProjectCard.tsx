      ...
      <div className="bg-white rounded-xl border border-slate-100 p-4 hover:border-[#1D6FA4]/40 hover:shadow-sm transition-all cursor-pointer group">
        ...
        <div className="flex items-start justify-between gap-2 mb-3">
          <div className="flex items-center gap-2.5 min-w-0">
            {/* アイコン */}
            <div className="w-9 h-9 rounded-lg border border-slate-100 bg-slate-50 flex items-center justify-center shrink-0 overflow-hidden">
              {iconUrl ? (
                <img
                  src={iconUrl}
                  alt=""
                ...
                <span className="text-lg text-slate-300 select-none">📁</span>
              )}
            </div>
